...
module.exports = class Game extends Backbone.Model
  ...
  generateDeck: ->
    ...
    deck.push type: 'weapon', name: 'Pot', damage: 3, description: 'Stolen from the kitchen of a mad chef the magical Frying Pan is bloody', playCost: 3, useCost : 2
    ...
    deck.push type: 'spell', name: 'the jesus', damage: 0, description: 'poop', playCost: 2, useCost: 0
    deck.push type: 'spell', name: 'the jesus', damage: 0, description: 'poop', playCost: 2, useCost: 0
    deck.push type: 'spell', name: 'the jesus', damage: 0, description: 'poop', playCost: 2, useCost: 0
    deck.push type: 'spell', name: 'the jesus', damage: 0, description: 'poop', playCost: 2, useCost: 0
    deck.push type: 'spell', name: 'the jesus', damage: 0, description: 'poop', playCost: 2, useCost: 0
